...
class ModelInteractor:
    ...
    def run_single_comparison(
        ...
        for prompt_name, (prompt_method, add_generation_prompt) in prompt_methods.items():
            ...
            start_time = time.time()
            response = self.execute_llm_request(prompt_method(include_system_prompt=False),add_generation_prompt=add_generation_prompt, verbose=verbose)
            setattr(cai_prompts, prompt_name, response)
            end_time = time.time()
    ...
    def save_comparison_data_to_csv(self, responses, output_file):
        ...
        with open(output_file, mode='w', newline='', encoding='utf-8') as file:
            ...
            for response in responses:
                ...
                selected_answer = response["selected_answer"].strip()
